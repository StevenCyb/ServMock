...
func TestBuild_HeaderSuccess(t *testing.T) {
	sections := []ini.Section{
		{Name: "GET /header", LineIndex: 7,
			Properties: []ini.Property{{Key: "header",
				Value: "X-Test: Value", LineIndex: 7}}},
	}
	bs, err := Build(sections)
	require.NoError(t, err)
...
func TestBuild_CookieUnknownProperty(t *testing.T) {
	sections := []ini.Section{
		{Name: "GET /cookie", LineIndex: 11,
			Properties: []ini.Property{{Key: "cookie.name", Value: "foo"},
				{Key: "cookie.unknown", Value: "val", LineIndex: 11}}},
	}
	bs, err := Build(sections)
	assert.Nil(t, bs)
	require.Error(t, err)
...
func TestBuild_CookieInvalidMaxAge(t *testing.T) {
	sections := []ini.Section{
		{Name: "GET /cookie", LineIndex: 12,
			Properties: []ini.Property{{Key: "cookie.name", Value: "foo"},
				{Key: "cookie.max_age", Value: "not_an_int", LineIndex: 12}}},
	}
	bs, err := Build(sections)
	assert.Nil(t, bs)
	require.Error(t, err)
...
func TestBuild_CookieInvalidRawExpires(t *testing.T) {
	sections := []ini.Section{
		{Name: "GET /cookie", LineIndex: 13,
			Properties: []ini.Property{{Key: "cookie.name", Value: "foo"},
				{Key: "cookie.raw_expires", Value: "not_a_date", LineIndex: 13}}},
	}
	bs, err := Build(sections)
	assert.Nil(t, bs)
	require.Error(t, err)
...
func TestBuild_CookieInvalidExpires(t *testing.T) {
	sections := []ini.Section{
		{Name: "GET /cookie", LineIndex: 14,
			Properties: []ini.Property{{Key: "cookie.name", Value: "foo"},
				{Key: "cookie.expires", Value: "not_a_duration", LineIndex: 14}}},
	}
	bs, err := Build(sections)
	assert.Nil(t, bs)
	require.Error(t, err)
...
func TestBuild_CookieSameSiteStrict(t *testing.T) {
	sections := []ini.Section{
		{Name: "GET /cookie", LineIndex: 15,
			Properties: []ini.Property{{Key: "cookie.name", Value: "foo"},
				{Key: "cookie.same_site", Value: "strict", LineIndex: 15}}},
	}
	bs, err := Build(sections)
	require.NoError(t, err)
	cookie := bs.Behaviors[0].ResponseBehavior.Cookies[0]
...
func TestBuild_CookieSameSiteNone(t *testing.T) {
	sections := []ini.Section{
		{Name: "GET /cookie", LineIndex: 16,
			Properties: []ini.Property{{Key: "cookie.name", Value: "foo"},
				{Key: "cookie.same_site", Value: "none", LineIndex: 16}}},
	}
	bs, err := Build(sections)
	require.NoError(t, err)
	cookie := bs.Behaviors[0].ResponseBehavior.Cookies[0]
...
func TestBuild_CookieSameSiteInvalid(t *testing.T) {
	sections := []ini.Section{
		{Name: "GET /cookie", LineIndex: 17,
			Properties: []ini.Property{{Key: "cookie.name", Value: "foo"},
				{Key: "cookie.same_site", Value: "invalid", LineIndex: 17}}},
	}
	bs, err := Build(sections)
	assert.Nil(t, bs)
	require.Error(t, err)
...
func TestBuild_RedirectProperty(t *testing.T) {
	sections := []ini.Section{
		{Name: "GET /redirect", LineIndex: 18,
			Properties: []ini.Property{{Key: "redirect", Value: "/new", LineIndex: 18}}},
	}
	bs, err := Build(sections)
	require.NoError(t, err)
...
func TestBuild_SSEPropertyTrue(t *testing.T) {
	sections := []ini.Section{
		{Name: "GET /stream", LineIndex: 19,
			Properties: []ini.Property{{Key: "sse", Value: "true", LineIndex: 19}}},
	}
	bs, err := Build(sections)
	require.NoError(t, err)
...
func TestBuild_SSEPropertyFalse(t *testing.T) {
	sections := []ini.Section{
		{Name: "GET /stream", LineIndex: 20,
			Properties: []ini.Property{{Key: "sse", Value: "false", LineIndex: 20}}},
	}
	bs, err := Build(sections)
	require.NoError(t, err)
